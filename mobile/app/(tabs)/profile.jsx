...
export default function Profile() {
  ...
  const renderTabIndicator = () => (
    <View style={styles.tabContainer}>
      <TouchableOpacity
        style={[styles.tab, activeTab === 'recipes' ? styles.activeTab : null]}
        onPress={() => handleTabChange('recipes')}
      >
        <Text
          style={[
            styles.tabText,
            activeTab === 'recipes' ? styles.activeTabText : null,
          ]}
        >
          Recipes
        </Text>
      ...
      <TouchableOpacity
        style={[styles.tab, activeTab === 'lists' ? styles.activeTab : null]}
        onPress={() => handleTabChange('lists')}
      >
        <Text
          style={[
            styles.tabText,
            activeTab === 'lists' ? styles.activeTabText : null,
          ]}
        >
          Lists
        </Text>
